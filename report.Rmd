---
title: "Using Data Visualization to Explore the Problem with the MTA's Operations"
...
In the midst of all the problems with subway service, the MTA hopes to utilize another $50 billion to repair subway stations, to add new signal systems, and to modernize the look of subway cars.  This is in addition to the escalating MTA budget as seen below (Meyer, David et. al).  But is such a massive new expense necessary?
